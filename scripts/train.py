...
def main(
    ...
    if IS_COLAB:
        args = get_args_colab(
            ...
            heads=heads or 4,
            dropout=dropout or 0.08,
            patience=patience or 18,
            min_epochs_before_stop=min_epochs_before_stop or 110,
        ...
        parser.add_argument("--min-epochs-before-stop", type=int, default=110)
